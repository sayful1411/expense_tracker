    ...
    <div class="container mx-auto py-10">
        <div class="max-w-3xl mx-auto">
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{ __('Categories') }}</h1>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ __('Organize your expenses into your own categories.') }}</p>
                </div>
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-white/10">
                            @forelse($categories as $category)
                                <tr class="transition hover:bg-gray-50/60 dark:hover:bg-white/5">
                                    ...
                                    <td class="px-5 py-3.5 text-right text-gray-500 dark:text-gray-400 tabular-nums">
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="px-5 py-16 text-center">
                                        <flux:icon.tag class="mx-auto size-10 text-gray-300 dark:text-gray-600" />
                                        <p class="mt-3 text-sm font-medium text-gray-900 dark:text-white">{{ __('No categories yet.') }}</p>
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('Add your first category to organize expenses.') }}</p>
                                        <a href="{{ route('categories.create') }}"
